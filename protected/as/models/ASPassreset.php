 ...
 */
class ASPassreset extends ASModel
{
	...
	public function rules()
	{
		...
		return array(
			array('resetpass,user', 'required'),
			array('uid, isused, status', 'numerical', 'integerOnly'=>true),
			...
			array('id, uid, resetpass, date_created, last_modified, isused, status, iplog, useragentlog', 'safe', 'on'=>'search'),
		);
	}
	...
	public function search()
	{
		...
		$criteria->compare('status',$this->remove);
